...
import { selectData } from "../../Action/Action";
...
const Navbar = () => {
    ...
    return (
        <div className="top-header " style={{ marginBlock: "10px", paddingLeft: "13px" }}>
            <div className="displayButton">
                ...
                >
                    {" "}
                    <span style={{ display: "flex", alignItems: "center" }}><img src={displayImage} alt="logo" style={{ marginRight: "8px" }} /> Display <img src={down} alt="logo" style={{ marginLeft: "8px" }} /></span>
                </button>
                {displayOnClick && (
                    <>
